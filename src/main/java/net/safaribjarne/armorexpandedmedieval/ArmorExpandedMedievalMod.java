package net.safaribjarne.armorexpandedmedieval;

import net.safaribjarne.armorexpandedmedieval.init.*;
...
public class ArmorExpandedMedievalMod {
	...
	public static final String MODID = "armor_expanded_medieval";
	...
	public ArmorExpandedMedievalMod(IEventBus modEventBus) {
		...
		ArmorExpandedMedievalModDataComponents.REGISTRY.register(modEventBus);


		ArmorExpandedMedievalModRecipes.REGISTRY.register(modEventBus);

		if (ModList.get().isLoaded("curios")) {
			modEventBus.addListener(ArmorExpandedMedievalModCuriosCompat::registerCapabilities);
