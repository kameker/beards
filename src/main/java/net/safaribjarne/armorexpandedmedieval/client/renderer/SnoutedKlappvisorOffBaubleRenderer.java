...
public class SnoutedKlappvisorOffBaubleRenderer implements ICurioRenderer {
	private static final ResourceLocation TEXTURE = ResourceLocation.parse("armor_expanded_medieval:textures/entities/helmet_visor_noised.png");
	private final HumanoidModel humanoidModel;

	public SnoutedKlappvisorOffBaubleRenderer() {
        Modelhelmetattachment model = new Modelhelmetattachment(Minecraft.getInstance().getEntityModels().bakeLayer(Modelhelmetattachment.LAYER_LOCATION));
        this.humanoidModel = new HumanoidModel(new ModelPart(Collections.emptyList(), Map.of(
            "hat", new ModelPart(Collections.emptyList(), Collections.emptyMap()),
               "head", model.snoutvisorup,
