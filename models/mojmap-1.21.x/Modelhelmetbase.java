...
public class Modelhelmetbase<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "helmetbase"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition helmet = partdefinition.addOrReplaceChild("helmet", CubeListBuilder.create().texOffs(0, 0)
				.addBox(-4.0F, -8.65F, -4.0F, 8.0F, 2.0F, 8.0F, new CubeDeformation(0.0F)),
				PartPose.offset(0.0F, 0.0F, 0.0F));

		PartDefinition cube_r1 = helmet.addOrReplaceChild("cube_r1",
				CubeListBuilder.create().texOffs(18, 10).addBox(-0.5F, -2.0F, -4.0F, 1.0F, 3.0F, 8.0F,
		...
		PartDefinition cube_r2 = helmet.addOrReplaceChild("cube_r2",
				CubeListBuilder.create().texOffs(0, 10).addBox(-0.5F, -2.0F, -4.0F, 1.0F, 3.0F, 8.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(3.8429F, -6.5233F, 0.0F, 0.0F, 0.0F, -0.1309F));

		PartDefinition cube_r3 = helmet.addOrReplaceChild("cube_r3",
				CubeListBuilder.create().texOffs(32, 25).addBox(-4.0F, -2.0F, -0.5F, 8.0F, 3.0F, 1.0F,
		...
		PartDefinition cube_r4 = helmet.addOrReplaceChild("cube_r4",
				CubeListBuilder.create().texOffs(32, 21).addBox(-4.0F, -2.0F, -0.5F, 8.0F, 3.0F, 1.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, -6.4905F, 3.797F, 0.1309F, 0.0F, 0.0F));

		PartDefinition cube_r5 = helmet.addOrReplaceChild("cube_r5",
				CubeListBuilder.create().texOffs(16, 31).addBox(-1.0F, -3.0F, -5.0F, 1.0F, 3.0F, 7.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(4.4691F, 0.3971F, 2.0F, 0.0F, 0.0F, 0.0436F));

		PartDefinition cube_r6 = helmet.addOrReplaceChild("cube_r6",
				CubeListBuilder.create().texOffs(0, 31).addBox(-1.0F, -3.0F, -5.0F, 1.0F, 3.0F, 7.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(4.6F, -2.6F, 2.0F, 0.0F, 0.0F, -0.0436F));

		PartDefinition cube_r7 = helmet.addOrReplaceChild("cube_r7",
				CubeListBuilder.create().texOffs(16, 21).addBox(0.0F, -3.0F, -5.0F, 1.0F, 3.0F, 7.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-4.4691F, 0.3971F, 2.0F, 0.0F, 0.0F, -0.0436F));

		PartDefinition cube_r8 = helmet.addOrReplaceChild("cube_r8",
				CubeListBuilder.create().texOffs(0, 21).addBox(0.0F, -3.0F, -5.0F, 1.0F, 3.0F, 7.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-4.6F, -2.6F, 2.0F, 0.0F, 0.0F, 0.0436F));

		PartDefinition cube_r9 = helmet
				.addOrReplaceChild("cube_r9",
						CubeListBuilder.create().texOffs(32, 0).addBox(-7.0F, -6.0F, 0.0F, 8.0F, 6.0F, 1.0F,
								new CubeDeformation(0.0F)),
						PartPose.offsetAndRotation(3.0F, 0.5F, 3.95F, 0.0873F, 0.0F, 0.0F));
