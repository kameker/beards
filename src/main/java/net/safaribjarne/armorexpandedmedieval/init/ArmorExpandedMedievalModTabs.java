...
public class ArmorExpandedMedievalModTabs {
	...
	public static final DeferredHolder<CreativeModeTab, CreativeModeTab> CREATIVE_TAB = REGISTRY.register("creative_tab",
			() -> CreativeModeTab.builder().title(Component.translatable("item_group.armor_expanded_medieval.creative_tab")).icon(() -> new ItemStack(ArmorExpandedMedievalModItems.FULLBEARD_LONG.get())).displayItems((parameters, tabData) -> {
