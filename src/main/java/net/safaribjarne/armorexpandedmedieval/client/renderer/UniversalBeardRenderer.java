...
import net.safaribjarne.armorexpandedmedieval.util.BeardColorUtil;
import net.safaribjarne.armorexpandedmedieval.init.ArmorExpandedMedievalModDataComponents;
...
public class UniversalBeardRenderer implements ICurioRenderer {
    ...
    private ResourceLocation getTextureForItem(ItemStack stack) {
        if (isVisor) {
            return ResourceLocation.parse("armor_expanded_medieval:textures/entities/helmet_visor_noised.png");
        }
        ...
        if (colorIndex == BeardColorUtil.DEFAULT_COLOR) {
            return ResourceLocation.parse("armor_expanded_medieval:textures/entities/beards_texture_noised.png");
        }

        return COLOR_TEXTURES.computeIfAbsent(colorIndex,
                key -> ResourceLocation.parse(
                        String.format("armor_expanded_medieval:textures/entities/beards/beard_%d.png", key)
                )
        );
    }
}