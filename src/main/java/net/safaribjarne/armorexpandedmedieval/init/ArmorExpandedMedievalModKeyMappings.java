...
import net.safaribjarne.armorexpandedmedieval.network.HelmetAttachmentMessage;
...
public class ArmorExpandedMedievalModKeyMappings {
	public static final KeyMapping HELMET_ATTACHMENT = new KeyMapping("key.armor_expanded_medieval.helmet_attachment", GLFW.GLFW_KEY_DOWN, "key.categories.misc") {
